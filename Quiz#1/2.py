...
elif n5 >= 3.0 and n5 <= 4.5:
    print("El quinto estudiante aprobo")
elif n5 > 4.5:
    print("Felicidades al quinto estudiante aprobo con exitos")

Prom = (n1 + n2 + n3 + n4 + n5) / 4

if Prom >= 3.5:
    print("Promedio positivo :3")
elif Prom < 3.5:
    print("Promedio negativo :3")